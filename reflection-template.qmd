...
### Justification: I strictly practicing good spacing, returning, and labeling practices when I code. I do this as much for myself as for anyone else. I also use chunk options intelligently and pre-emptively so that readers see what they need to. I believe this post is a good example of these in action:
